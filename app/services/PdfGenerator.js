					...
					content: [
						...
						},
						{
							...
							stack: [
								...
								{
									text: "Ballot of Plots In Victoria City, Lahore",
									margin: [50, -12, 0, 0],
									fontSize: 10,
									bold: true,
									decoration: "underline"
								...
								{
									text: `Management Victoria City is pleased to announce the Ballot of plots in Victoria City, Lahore. No of plots are limited so respected members are to benefit from this golden	opportunity and expedite payment of outstanding dues and ballot amount by 31st May 2024.`,
									margin: [0, 23, 0, 0],
									fontSize: 10,
									lineHeight: 1.5
								},
