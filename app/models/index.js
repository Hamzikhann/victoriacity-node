...
db.Restorationfee = require("./Restorationfee")(sequelize, Sequelize);
...
db.Booking.hasOne(db.Restorationfee, { as: "Restorationfee", foreignKey: "id" });
...
db.Restorationfee.belongsTo(db.Booking, { as: "Booking", foreignKey: "BK_ID" });
...
db.CalenderComment.belongsTo(User, { as: "User", foreignKey: "USER_ID" });
...
db.InstallmentReceipts.belongsTo(db.BookingInstallmentDetails, {
	as: "Booking_Installment_Details",
	foreignKey: "BKI_DETAIL_ID"
});
...
User.hasMany(db.CalenderComment, { as: "Comments", foreignKey: "id" });
