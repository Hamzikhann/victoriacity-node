...
class VoucherController {
	...
	static getVoucherById = async (req, res, next) => {
		...
		try {
			const voucherById = await Voucher.findOne({
				include: [
					{ as: "VoucherType", model: VoucherType },
					{ as: "VoucherReason", model: VoucherReason }
				],
	...
	static updateUser = async (req, res, next) => {
		...
		try {
			...
			result = await Voucher.update({ Assign_BY: userId }, { where: { VOUCHER_ID: voucherId }, returning: true });
